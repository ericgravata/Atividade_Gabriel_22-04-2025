...
3° Faz o commit de todos os arquivos disponíveis --> [git commit -m "breve_decrição_do_commit(opcional)"]

4° Faz o push (empurra tudo no github) --> [git push -u origin nome_da_branch_que_vai_fazer_o_commit]
